...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function getActivePlayerIndex(
        ...
        // @audit if the player is at index 0, it'll return 0 and  a player might  think they
        //are not active!
        return 0;
    }
    ...
    function selectWinner() external {
        ...
        // @audit overflow
        //Fixes:Never versions of solidity,bigger uints
        ...
        //writtern recommend to follow CEI
    ...
    function withdrawFees() external {
        //@audit mishandling of ETH using selfdestruct
        require(
